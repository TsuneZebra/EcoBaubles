...
public class ItemRingFrostBlade extends Item implements IBauble {

    public ItemRingFrostBlade(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(I18n.format("item.frost_blade_ring.desc"));
    }
