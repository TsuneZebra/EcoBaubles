...
public class ItemBodyFerventCloak extends Item implements IBauble {

    public ItemBodyFerventCloak(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(I18n.format("item.fervent_cloak.desc"));
    }
