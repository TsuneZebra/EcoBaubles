...
public class ItemRingLightningChain extends Item implements IBauble {

    public ItemRingLightningChain(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(I18n.format("item.lightning_chain_ring.desc"));
    }
