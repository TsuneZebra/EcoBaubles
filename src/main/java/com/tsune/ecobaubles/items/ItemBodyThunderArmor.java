...
public class ItemBodyThunderArmor extends Item implements IBauble {

    public ItemBodyThunderArmor(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(I18n.format("item.thunder_armor.desc"));
    }
