...
public class ItemRingIcePrison extends Item implements IBauble, IActiveAbility {

    public static final String TAG_COOLDOWN_TICK = "ice_prison_ring_cd";
    public static final int COOLDOWN_TICKS = 40 * 20; // 40s = 800 ticks

    public ItemRingIcePrison(String name) {
    ...
    public void useAbility(EntityPlayer player, ItemStack stack) {
        ...
        boolean is = IceEventHandler.hasIceSpirit(player);
        int cd = is ? 30 * 20 : COOLDOWN_TICKS; // ice spirit: 30s cd
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(I18n.format("item.ice_prison_ring.desc"));
        ...
        if (worldIn != null) {
            ...
            if (remain > 0) {
                tooltip.add(I18n.format("item.ice_prison_ring.cooldown"));
            } else {
