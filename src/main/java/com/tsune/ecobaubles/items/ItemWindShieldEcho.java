...
public class ItemWindShieldEcho extends Item implements IBauble {
    public ItemWindShieldEcho(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(I18n.format("item.wind_shield_echo.desc"));
        tooltip.add("");
        tooltip.add(I18n.format("item.wind_shield_echo.probability"));
