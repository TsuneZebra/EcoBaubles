...
public class ItemBeltThunderPulse extends Item implements IBauble {

    public ItemBeltThunderPulse(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(I18n.format("item.thunder_pulse_belt.desc"));
        net.minecraft.client.entity.EntityPlayerSP player = Minecraft.getMinecraft().player;
        if (player != null) {
            float staticVal = ThunderEventHandler.getStaticMeter(player.getUniqueID());
            tooltip.add("\u00a7e\u9759\u7535: " + (int) staticVal + " \u5c42");
        }
    }
