...
public class ItemCharmThunderBolt extends Item implements IBauble {

    public ItemCharmThunderBolt(String name) {
    ...
    public void addInformation(ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn) {
        ...
        tooltip.add(I18n.format("item.thunder_bolt_pendant.desc"));
    }
